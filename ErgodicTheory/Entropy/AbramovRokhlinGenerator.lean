...
The bridge is `ErgodicTheory.Entropy.abramovRokhlin_partition` (the unconditional partition-level
...
* `ErgodicTheory.Entropy.abramov_rokhlin_of_generator`: the addition formula

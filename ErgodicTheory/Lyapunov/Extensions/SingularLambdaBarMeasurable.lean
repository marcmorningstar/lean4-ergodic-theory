...
* `ErgodicTheory.measurableSubspace_of_tendsto_orthProjMatrix` — the **fully general** soft lemma: a
...
* `ErgodicTheory.measurableSubspace_lambdaSublevel_of_tendsto` — the **det-free reduction**: if for

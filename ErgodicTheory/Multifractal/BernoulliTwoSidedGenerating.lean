...
The Krieger finite-generator interface (`ErgodicTheory/Krieger/ZIterate.lean`) consumes a
...
* `ErgodicTheory.Multifractal.coordPartitionZFin_isGeneratingTwoSided`:

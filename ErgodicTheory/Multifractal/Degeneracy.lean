...
* `ErgodicTheory.Multifractal.partitionFunction_equalMeasure`: for the uniform family,
  `Z_q = N ^ (1 - q)`.
* `ErgodicTheory.Multifractal.renyiDim_equalMeasure`: for the uniform family and `0 < ε < 1`,

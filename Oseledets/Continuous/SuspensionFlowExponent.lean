...
* `Oseledets.coverCocycle_returnTime_tendsto_exponent`: the **headline return-time flow exponent**.
...
* `Oseledets.IsOseledetsFiltration.coverCocycle_returnTime_tendsto_topExponent`: the concrete

...
(`Oseledets.Entropy.AbramovRokhlinPartition`) rests on a named hypothesis `hW3`, which identifies
...
* `Oseledets.Entropy.tendsto_condCellSeq_of_defect`: under `hdefect`, the Cesàro average of the
...
* `Oseledets.Entropy.abramovRokhlin_partition_of_defect`: the partition-level Abramov–Rokhlin

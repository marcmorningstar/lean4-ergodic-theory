...
* `Oseledets.Entropy.entropy_joinCells_of_refines` (W1): the refinement collapse of join entropy.
* `Oseledets.Entropy.entropy_join_eq_of_refines`: the per-`n` identity

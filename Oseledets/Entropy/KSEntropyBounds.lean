...
* `Oseledets.Entropy.ksEntropySeq_one`: `ksEntropySeq hT P 1 = entropy μ P.cells`.
* `Oseledets.Entropy.ksEntropySeq_le_nsmul`: `ksEntropySeq hT P n ≤ n • entropy μ P.cells`.
* `Oseledets.Entropy.ksEntropyPartition_nonneg`: `0 ≤ ksEntropyPartition hT P`.
* `Oseledets.Entropy.ksEntropyPartition_le_entropy`: `ksEntropyPartition hT P ≤ entropy μ P.cells`.

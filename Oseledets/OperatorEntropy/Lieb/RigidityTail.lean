...
-/
import Mathlib
import Oseledets.OperatorEntropy.Lieb.StrictLog
import Oseledets.OperatorEntropy.Lieb.PetzSufficiencyB
...
(`Oseledets.OperatorEntropy.Lieb.cfc_neg_log_eq_integral`) turns the `-log` gap into an integral of
...
(`Oseledets.OperatorEntropy.Lieb.exists_resolvent_combo`) upgrades resolvent intertwining to

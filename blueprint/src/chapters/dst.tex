...
(a companion descriptive-set-theoretic result, consumed by the measurable Livšic tier) and closes
with an honest statement of the general \(\sigma\)-compact-section theorem (Arsenin--Kunugui) as a
documented research frontier.
